...
def main(**args):
    ...
    camera = create_camera(dtype=dtype,
                           **args)
    ...
    for idx, data in enumerate(dataset_obj):
        ...
        for person_id in range(keypoints.shape[0]):
            ...
            # print("img, keypoints[[person_id]]: ", img, keypoints[[person_id]])
            print('keypoints[[person_id]],keypoints3d[[person_id]]: ', keypoints[[person_id]],keypoints3d[[person_id]])
            fit_single_frame(img, keypoints[[person_id]],keypoints3d[[person_id]],
